...
a Candidate, withholding an Offering, rolling back a bad config. It also
holds the optional Headroom setup, which reports how drawn each Allowance
is. That step is off by default, and it needs a source that measures your
own credentials. Read
