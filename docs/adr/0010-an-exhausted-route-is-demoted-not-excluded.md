...
**Generalised 2026-08-01 by ADR 0014.** The reasoning below applied to
one cause, a quota exhaustion. It now applies to every condition the
Prober and the Observation Journal record: an Excluded Offering stays in
the Generated Config too. Only Withheld and Gone remove one. What is
written below still holds, and describes the case that came first.
